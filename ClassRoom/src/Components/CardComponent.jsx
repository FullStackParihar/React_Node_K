...
const ProductCard = ({ product }) => {
  return (
    <div
      className={`w-[20rem] relative bg-gradient-to-br from-${product.color}-50 to-${product.color}-100 shadow-lg rounded-lg overflow-hidden relative transform hover:scale-105 hover:shadow-2xl transition-transform duration-300 `}
    >
      {/* Product Image */}
      <img
